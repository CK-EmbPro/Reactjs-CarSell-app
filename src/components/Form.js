...
const Form = () => {
  ...
  return (
    <div className='container'>
        <h1 style={{color:"grey"}}>Simple Car Sell Form</h1>
        <form>
            <div className="input">
            ...
            <label htmlFor="date">Year Of Production</label>
            ...
            <label htmlFor="">Car Features</label> <br />
            <input
            type="checkbox"
            ...
            Navigation System
             ...
             <br />
             <br />
             <label htmlFor="transmission-select">Car Transmission:</label>
            ...
            <label htmlFor="">Car Price Range</label> <br />
            <label htmlFor="priceRange">Range:</label>
            <input
              type="range"
              id="priceRange"
              min="0"
            ...
            <div className='output'>
              <h1>Car General Information:</h1> <br /> <br />
              <p>Name:   {name}</p>
              <p>Model:   {model}</p>
              <p>Date:   {date}</p>
              <p>Mileage:   {mileage}</p>
